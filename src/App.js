...
function App() {
  ...
  }, [vantaEffect]); // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'text-white' : 'text-black'}`}>
      <div
        ref={vantaRef}
      ...
      <div className="flex-grow flex flex-col">
        ...
        <main ref={contentRef} className="flex-grow max-w-7xl mx-auto px-4 py-8 w-full z-10">
          ...
          <div className={`md:hidden flex justify-center items-center mt-4 text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-500'} gap-4`}>
