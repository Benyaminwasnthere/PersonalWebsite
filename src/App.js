...
<p className="mb-6">
  ...
  >
    ...
    photography: <PhotographySection isDarkMode={isDarkMode} />, // Changed from "Photography" to "photography"
  ...
  return (
    ...
    >
      ...
      <main 
        ref={contentRef}
        className="flex-grow max-w-7xl mx-auto px-4 py-8 w-full z-10"
      >
